...
export function Settings({ data, updateData, isSetting, closeSetting }) {
  ...
  return (
    ...
    absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 transform w-80 md:w-90 h-60 rounded-xl border 
    border-ctp-lavender bg-ctp-mantle/95 flex justify-center items-center font-poppins text-ctp-text `}>
      ...
      <Icon name="XMarkIcon"  
      className="size-7 border p-1 bg-center text-ctp-lavender rounded-full cursor-pointer hover:border-ctp-lavender hover:text-ctp-base hover:bg-ctp-lavender" />
      </button>
      <form className="flex flex-col gap-2">
        <h1 className="text-lg md:text-xl">Focus Time</h1>
        ...
        <h1 className="text-lg md:text-xl">Break Time</h1>
        ...
        <div className="flex justify-between mt-1">
          <label htmlFor="autoResume" className="text-lg md:text-xl">Auto resume</label>
